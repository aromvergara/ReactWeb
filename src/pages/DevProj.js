          ...
          <main>
            <section>
              ...
              <article className="projects">
                <div className="projects-item projects-item-01">
                  ...
                  <a onClick={()=> window.open("https://aromvergara.github.io/Netflix-Clone", "_blank")} href="/DevProj" data-title="Website Clone"><img src="images/webclone.png" alt="Website Clone" /></a>
                </div>
                <div className="projects-item projects-item-02">
                  {/*img src="images/webdevelopment.png" alt="Web Development"*/}
                  <a onClick={()=> window.open("https://crud-notess.herokuapp.com", "_blank")} href="/DevProj" data-title="CRUD App"><img src="images/crudapp.png" alt="CRUD App" /></a>
                </div>
            ...
            <section>
              <article className="projects">
                <div className="projects-item projects-item-03">
                  {/*img src="images/projectmanagement.jpg" alt="Project Management"*/}
                  <a onClick={()=> window.open("https://weather-app-ciccc.herokuapp.com", "_blank")} href="/DevProj" data-title="Weather App"><img src="images/projectmanagement.jpg" alt="Weather App" /></a>
                </div>
              </article>
            </section>
          </main>
